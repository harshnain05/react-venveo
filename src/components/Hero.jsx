...
const Hero = () => {
  return (
    <div>
      ...
      <img className='max-w-[800px] sm:hidden max-sm:block max-h-[335px] max-sm:max-w-[328px] w-full mx-auto -translate-y-[127px]' src='./assets/image/png/sm-hero-sec.png' alt="sm-hero-img" />
    </div>
  )
}
