...
const Hero = () => {
  return (
    <div>
      <div className='bg-[#097980] relative xl:pb-[322px] lg:pb-60 sm:pb-56 pb-[175px]'>
      ...
      <img className='xl:max-w-[924px] max-w-[800px] sm:block max-sm:hidden w-full mx-auto xl:-translate-y-64 lg:-translate-y-48 -translate-y-44' src='./assets/image/png/hero-sec.png' alt="overlay-img" />
      <img className='xl:max-w-[924px] max-w-[800px] sm:hidden max-sm:block max-h-[335px] max-sm:max-w-[328px] w-full mx-auto -translate-y-[127px]' src='./assets/image/png/sm-hero-sec.png' alt="overlay-img" />
    </div>
  )
}
